...
export default function Image() {
 return new ImageResponse(<div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", width: "100%", height: "100%", padding: 64, background: "#f3efe6", color: "#141411", fontFamily: "sans-serif" }}>
   ...
   <div style={{ display: "flex", fontSize: 66, lineHeight: 1.1, color: "#2457ff" }}>AI Content & Technical Communication</div>
   <div style={{ display: "flex", fontSize: 27 }}>Research / technical storytelling / developer education</div>
   <div style={{ display: "flex", fontSize: 22 }}>One identity. Evidence you can inspect. /content</div>
 </div>, size);
}
