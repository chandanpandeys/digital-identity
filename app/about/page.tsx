...
export const metadata: Metadata = {
  title: "About",
  description:
    "The through-line behind Chandan Pandey's work across AI engineering, applied research, developer tooling, education, and technical communication.",
...
const chapters = [
  {
    ...
    links: [
      { label: "Creator chapter", href: "/content#teaching" },
      { label: "Full timeline", href: "/timeline" },
    ],
  },
  {
    index: "02",
    ...
    links: [
      { label: "EpitopePred", href: "/work/epitopepred" },
  ...
  },
  {
    ...
    label: "SYSTEMS",
    title:
      "The current focus is turning technical questions into inspectable software.",
    body: "ByteToken asks how agent payloads can use context more efficiently. BenchWolf asks how to judge local LLMs on the hardware that actually runs them. DekhoSuno asks how multimodal AI can become an accessibility interface. Different domains, but the working pattern is the same: define the problem, build the system, measure what matters, and leave evidence behind.",
    links: [
      { label: "Work index", href: "/work" },
      { label: "Ask the evidence", href: "/ask" },
    ],
  },
] as const;
...
const principles = [
  [
    ...
    "A strong claim should resolve to code, a benchmark, a public artifact, or a clearly labelled first-party record.",
  ],
  [
    "Useful beyond the demo",
    "I am more interested in systems, workflows, interfaces, and evaluation than in impressive-looking one-off outputs.",
  ],
  [
    "Explanation is part of the product",
    "Documentation, research communication, teaching, and technical storytelling are ways of making a system usable—not side activities.",
  ],
] as const;
  ...
  return (
    <main id="main" className="inner-page about-page-v2">
      ...
      <section className="site-shell about-thesis">
        ...
        <div>
          <p className="about-thesis-lede">
            I am an AI engineer and builder working across LLM infrastructure,
            applied research, developer tooling, accessibility, automation, and
            technical communication.
          </p>
          <p>
            The breadth only makes sense if you look at the method instead of
            the job titles. I keep returning to the same loop: understand a
            difficult problem, turn it into something operational, test the
            result, and explain the reasoning clearly enough that another person
            can inspect or use it.
          </p>
          <p>
            This portfolio is designed around that loop. It does not ask a
            recruiter to trust a long list of skills; it connects the claims to
            projects, public source, measurements, career records, and
            first-party context with different evidence strengths.
          </p>
        </div>
      </section>
      ...
      <section className="site-shell about-chapters">
        <div className="about-section-head">
          <p className="eyebrow">HOW THE WORK EVOLVED</p>
          <h2>Explain → research → systems.</h2>
        </div>
        {chapters.map((chapter) => (
          <article className="about-chapter" key={chapter.index}>
            ...
            <div className="about-chapter-links">
      ...
      <section className="site-shell about-proof">
        <div className="about-section-head">
          ...
          <h2>Start with what can be inspected.</h2>
        </div>
        <ul>
